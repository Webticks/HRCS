...
const FacilitiesMaintenanceAndManagement = () => {
  ...
  <div className="container">
    ...
    <div className="row align-items-center">
      ...
      {/* Content 2 */}
      <div className="col-xl-7 col-lg-6 order-3 order-lg-4">
      ...
      <div className="col-xl-5 col-lg-6 order-4 order-lg-3"  >
        <div className="optimization-one_content-box content-box-gap mb-50 wow fadeInLeft" >
          <ul className="check-style-three" >
            <li>
      ...
      {/* Content 3 */}
      <div className="col-xl-7 col-lg-6 order-5 order-lg-6">
        <div className="optimization-one_image-box text-lg-right mb-50 wow fadeInRight">
          <img
      ...
      <div className="col-xl-5 col-lg-6 order-6 order-lg-5">
        <div className="optimization-one_content-box content-box-gap mb-50 wow fadeInLeft">
          <ul className="check-style-three" >
            <li>
      ...
      {/* Content 4 */}
      <div className="col-xl-5 col-lg-6 order-8 order-sm-7"  >
        <div className="optimization-one_content-box content-box-gap mb-50 wow fadeInLeft">
          <ul className="check-style-three" >
            <li>
