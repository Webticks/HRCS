          ...
          <div className="row align-items-center">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="single-skill-item d-flex align-items-center mb-40 wow fadeInUp">
                      <ProgressBar value={85} color="#EDC253" />
                      <div className="text">
                  ...
                  <div className="col-md-6">
                    <div className="single-skill-item d-flex align-items-center mb-40 wow fadeInUp">
                      <ProgressBar value={67} color="#EDC253" />
                      <div className="text">
                  ...
                  <div className="col-md-6">
                    <div className="single-skill-item d-flex align-items-center mb-40 wow fadeInUp">
                      <ProgressBar value={78} color="#EDC253" />
                      <div className="text">
                  ...
                  <div className="col-md-6">
                    <div className="single-skill-item d-flex align-items-center mb-40 wow fadeInUp">
                      <ProgressBar value={59} color="#EDC253" />
                      <div className="text">
            ...
            <div className="col-xl-6 col-lg-12">
              ...
              <div className="skill-one_image-box p-r ml-lg-40 mb-50 wow fadeInRight">
                <Image src="assets/images/gallery/skil-1.jpg" alt="Skill Image" />
          ...
          <div className="row align-items-end">
            <div className="col-lg-6">
              ...
              <div className="author-image mb-50 wow fadeInLeft">
                <Image src="assets/images/team/author.jpg" alt="Author Image" />
              </div>
            </div>
            <div className="col-lg-6">
              {/*=== Author Content Box ===*/}
        ...
        <div className="container">
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              ...
              <div className="single-team-item mb-40 wow fadeInUp">
                <div className="img-holder">
                  <Image src="assets/images/team/team-8.jpg" alt="Team Image" />
                  <svg
                    className="team-shape"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              ...
              <div className="single-team-item mb-40 wow fadeInUp">
                <div className="img-holder">
                  <Image src="assets/images/team/team-9.jpg" alt="Team Image" />
                  <svg
                    className="team-shape"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              ...
              <div className="single-team-item mb-40 wow fadeInUp">
                <div className="img-holder">
                  <Image src="assets/images/team/team-10.jpg" alt="Team Image" />
                  <svg
                    className="team-shape"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              ...
              <div className="single-team-item mb-40 wow fadeInUp">
                <div className="img-holder">
                  <Image src="assets/images/team/team-11.jpg" alt="Team Image" />
                  <svg
                    className="team-shape"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              ...
              <div className="single-team-item mb-40 wow fadeInUp">
                <div className="img-holder">
                  <Image src="assets/images/team/team-12.jpg" alt="Team Image" />
                  <svg
                    className="team-shape"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              ...
              <div className="single-team-item mb-40 wow fadeInUp">
                <div className="img-holder">
                  <Image src="assets/images/team/team-13.jpg" alt="Team Image" />
                  <svg
                    className="team-shape"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
